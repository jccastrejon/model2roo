/*
 * Copyright 2012 jccastrejon, rosatzimba
 *  
...
public class Util {
    ...
    public static File getEcoreFile(ISelection currentSelection) {
    	File returnValue;
    	String ecoreFilePath;
    	String workspacePath;
    	
    	workspacePath = Util.getWorkspacePath();
    	ecoreFilePath = ((org.eclipse.core.internal.resources.File) ((TreeSelection) currentSelection).getFirstElement())
