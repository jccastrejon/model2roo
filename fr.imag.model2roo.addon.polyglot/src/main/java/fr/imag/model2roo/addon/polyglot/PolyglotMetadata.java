 ...
 * @since 1.1.0
 */
public class PolyglotMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

    // Constants
    private static final String PROVIDES_TYPE_STRING = PolyglotMetadata.class.getName();
    ...
    public PolyglotMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
