...
/**
 * Entry point of the 'Ecore2Roo' generation module.
 *
 * @generated
 */
public class Ecore2Roo extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/fr/imag/model2roo/ecore/main/Ecore2Roo";
     ...
     * @generated
     */
    public Ecore2Roo(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Ecore2Roo(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Ecore2Roo generator = new Ecore2Roo(modelURI, folder, arguments);
