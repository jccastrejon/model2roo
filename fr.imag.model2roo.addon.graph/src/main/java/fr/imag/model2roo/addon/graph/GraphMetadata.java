...
public class GraphMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {
    ...
    public GraphMetadata(String identifier, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata) {
    ...
    private FieldMetadata getSampleField() {
        ...
        final FieldMetadataBuilder fieldBuilder = new FieldMetadataBuilder(getId(), // Metadata
                                                                                    // ID
                                                                                    // provided
                                                                                    // by
                                                                                    // supertype
